...
public class ShadowTests {
    ...
    /**
     * Sphere-Triangle shading - move triangle up-right (first step)
     */
    @Test
    public void SphereTriangleMove1() {
        ...
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        new Point3D(-63, 32, 0), new Point3D(-32, 62, 0), new Point3D(-60, 60, 4)));
    ...
    /**
     * Sphere-Triangle shading - move triangle upper-right
     */
    @Test
    public void SphereTriangleMove2() {
        ...
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        new Point3D(-47, 20, 0), new Point3D(-17, 50, 5), new Point3D(-48, 48, 4)));
    ...
    public void SphereTriangleSpot1() {
        ...
        scene.addLights(new SpotLight(new Color(400, 240, 0), //
                new Point3D(-83, 83, -110), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
    ...
    public void SphereTriangleSpot2() {
        ...
        scene.addLights(new SpotLight(new Color(400, 240, 0), //
                new Point3D(-74.9, 74.9, -69), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
