...
public class LightTests {
    ...
    /**
     * using all lights on  a pair of triangles
     */
   @Test
    public  void triangleLights()
   {
       Scene scene = new Scene("Test scene");
       scene.set_camera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
       scene.set_distance(1000);
       ...
       scene.addLights(new SpotLight(new Color(500, 250, 250),
               new Point3D(100, 100, 130), new Vector(-2, 2, 1),
               1, 0.0001, 0.000005),new PointLight(new Color(500, 250, 250),
               new Point3D(10, 10, 130),
               1, 0.0005, 0.0005),new DirectionalLight(new Color(300, 150, 150), new Vector(1, 1, 1)));

       ImageWriter imageWriter = new ImageWriter("triangleLights", 200, 200, 500, 500);
       Render render = new Render(imageWriter, scene);
...
public void  sphereLights()
{
    ...
    scene.addLights(new SpotLight(new Color(400, 200, 0), new Point3D(-50, 50, -50),
            new Vector(1, -1, 2), 1, 0.00001, 0.00000001),
            new PointLight(new Color(500, 300, 0), new Point3D(-50, 50, -50), 1, 0.00001, 0.000001),
            new DirectionalLight(new Color(600, 400, 0), new Vector(1, -1, 1)));
